(function () {
    ...
    const exactMap = {
        ...
        '公网安全配置（P1）': 'Public Security Settings (P1)',
        ...
        '这里只配置 Email 通知通道。普通邮箱需在账号列表开启通知后才会通过 Email 发送。启用后仅从新到达的邮件开始通知。': 'This configures the Email notification channel only. Regular mailboxes send through Email only after notifications are enabled in the account list. Only newly arrived mail after enabling will trigger notifications.',
        ...
        '这里只配置 Telegram 通知通道。普通邮箱需在账号列表开启通知后才会通过 Telegram 发送。': 'This configures the Telegram notification channel only. Regular mailboxes send through Telegram only after notifications are enabled in the account list.',
